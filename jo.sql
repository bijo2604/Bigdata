...
insert into NoblePrizeWinner(YEAR,SUBJECT,WINNER,COUNTRY,CATEGORY)
...
SELECT * FROM NoblePrizeWinner
WHERE year = 1970
  AND category NOT IN ('Physiology', 'Economics');
